#!/usr/bin/env python3
"""
PyQt operator UI for the simplified V2 cap inspection runtime.
"""
...
import cap_line_runtime_v2 as cap_line_runtime_v2
from cap_line_runtime_v2 import DetectionHistoryRecord, TimingLogRecord
...
if PYQT_AVAILABLE:
    class DetectionApp(base_ui.DetectionApp):
        def __init__(
            ...
            *,
            ...
            self.setWindowTitle("Cap Line Inspector V2")
    ...
    class DetectionApp:  # type: ignore[no-redef]
        def __init__(self, *args, **kwargs):
            raise RuntimeError("PyQt6 is required to use cap_line_ui_v2.py")


    def main() -> None:
        raise RuntimeError("PyQt6 is required to run cap_line_ui_v2.py")
