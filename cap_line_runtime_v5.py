#!/usr/bin/env python3
"""Standalone v5 cap-inspection runtime entry point (headless).
...
from cap_line_v5.config import config_from_args, parse_args
from cap_line_v5.runtime import run_detection
from cap_line_v5.types import CapEventRecord, RuntimeCallbacks
