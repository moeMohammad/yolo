#!/usr/bin/env python3
"""Standalone v6 cap-inspection runtime entry point (headless).
...
from cap_line_v6.config import config_from_args, parse_args
from cap_line_v6.runtime import run_detection
from cap_line_v6.types import CapEventRecord, RuntimeCallbacks
