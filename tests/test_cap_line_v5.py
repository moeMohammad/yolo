"""Tests for the v5 cap-inspection runtime.
...
from cap_line_v5.actuation import NullGPIOOutputPin, RejectExecution, RejectScheduler
from cap_line_v5.config import RuntimeConfig, validate_config
from cap_line_v5.decision import CapEventManager
from cap_line_v5.model import postprocess
from cap_line_v5.runtime import resolve_pin_factory
from cap_line_v5.tracking import CameraTracker, Track
from cap_line_v5.types import CapEventRecord
...
def test_run_detection_fires_once_for_defect_cap():
    from cap_line_v5.runtime import run_detection
