#!/usr/bin/env python3
"""
Simplified two-class cap inspection runtime for conveyor deployment.
...
DEFAULT_PICTURES_DIR = os.path.join(RESOURCES_DIR, "pictures")
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            f"(default: {DEFAULT_TRIGGER_PIN}; GPIO09 is Jetson Nano BOARD pin 7)"
        ),
    )
